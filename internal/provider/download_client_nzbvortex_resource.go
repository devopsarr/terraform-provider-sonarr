...
func (r *DownloadClientNzbvortexResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *DownloadClientNzbvortex) write(ctx context.Context, downloadClient *sonarr.DownloadClientOutput) {
...
func (d *DownloadClientNzbvortex) read(ctx context.Context) *sonarr.DownloadClientInput {
	var tags []int
