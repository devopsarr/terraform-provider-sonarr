...
type Series struct {
	...
	//  Seasons []Season `tfsdk:"seasons"`
	//	Images            []Image        `tfsdk:"images"`
	// could be implemented, not sure about the value
	//  Ended             types.Bool 		`tfsdk:"ended"`
	//	Runtime           types.Int64  		`tfsdk:"runtime"`
	//	Year              types.Int64  		`tfsdk:"year"`
	//	TvMazeID          types.Int64  		`tfsdk:"tv_maze_id"`
	//	TvRageID          types.Int64  		`tfsdk:"tv_rage_id"`
	//	AirTime           types.String 		`tfsdk:"air_time"`
	//	Certification     types.String 		`tfsdk:"certification"`
	//	CleanTitle        types.String 		`tfsdk:"clean_title"`
	...
	//	FirstAired        types.String     	`tfsdk:"first_aired"` maybe
	//	Ratings           Ratings          	`tfsdk:"ratings"`
	//  Statistics        Statistics       	`tfsdk:"statistics"`
	//  AlternateTitles   []AlternateTitle 	`tfsdk:"alternate_titles"`
}
...
// AlternateTitle could be implemented if needed.
//type AlternateTitle struct {
//	SeasonNumber types.Int64  `tfsdk:"season_number"`
//	Title        types.String `tfsdk:"title"`
//}

// Statistics could be implemented if needed.
// type Statistics struct {
// 	SeasonCount       types.Int64   `tfsdk:"seasonCount"`
// 	EpisodeFileCount  types.Int64   `tfsdk:"episodeFileCount"`
// 	EpisodeCount      types.Int64   `tfsdk:"episodeCount"`
// 	TotalEpisodeCount types.Int64   `tfsdk:"totalEpisodeCount"`
// 	SizeOnDisk        types.Int64   `tfsdk:"sizeOnDisk"`
// 	PercentOfEpisodes types.Float64 `tfsdk:"percentOfEpisodes"`
// 	PreviousAiring    types.String  `tfsdk:"previousAiring"`
// }

// Ratings could be implemented if needed.
// type Ratings struct {
