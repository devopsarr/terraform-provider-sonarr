...
func (r *DownloadClientSabnzbdResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"recent_tv_priority": {
				...
				Validators: []tfsdk.AttributeValidator{
					tools.IntMatch([]int64{-100, -2, -1, 0, 1, 2}),
				},
			},
			"older_tv_priority": {
...
func (d *DownloadClientSabnzbd) write(ctx context.Context, downloadClient *sonarr.DownloadClientOutput) {
...
func (d *DownloadClientSabnzbd) read(ctx context.Context) *sonarr.DownloadClientInput {
	var tags []int
