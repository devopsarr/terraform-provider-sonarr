...
func (r *DownloadClientVuzeResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *DownloadClientVuze) write(ctx context.Context, downloadClient *sonarr.DownloadClientOutput) {
...
func (d *DownloadClientVuze) read(ctx context.Context) *sonarr.DownloadClientInput {
	var tags []int
