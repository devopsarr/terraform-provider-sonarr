...
func (r *DownloadClientDelugeResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *DownloadClientDeluge) write(ctx context.Context, downloadClient *sonarr.DownloadClientOutput) {
...
func (d *DownloadClientDeluge) read(ctx context.Context) *sonarr.DownloadClientInput {
	var tags []int
