...
func (d *DownloadClientTransmission) write(ctx context.Context, downloadClient *sonarr.DownloadClientOutput) {
...
func (d *DownloadClientTransmission) read(ctx context.Context) *sonarr.DownloadClientInput {
	var tags []int
