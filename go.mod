...
require (
	github.com/devopsarr/sonarr-go v0.6.0
...
replace github.com/hashicorp/terraform-plugin-docs => github.com/fuochi/terraform-plugin-docs v0.0.0-20230303070141-d2c1202cfe89
